export const canvas: typeof import("./canvas/canvas.ts") = await import("./canvas/canvas.ts");
...
export const network: typeof import("./network/network.ts") = await import("./network/network.ts");
